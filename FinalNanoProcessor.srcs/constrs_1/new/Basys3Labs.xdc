...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {OUT_REG[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {OUT_REG[0]}]
set_property PACKAGE_PIN E19 [get_ports {OUT_REG[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {OUT_REG[1]}]
set_property PACKAGE_PIN U19 [get_ports {OUT_REG[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {OUT_REG[2]}]
set_property PACKAGE_PIN V19 [get_ports {OUT_REG[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {OUT_REG[3]}]
